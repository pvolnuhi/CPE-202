...
class TestHeap(unittest.TestCase):
	...
	def test_06a_is_full(self):
		test_heap = MaxHeap(5)
		built = test_heap.build_heap([1, 2, 3, 4])
	...
	def test_12_heap_sort_ascending(self):
		test_heap = MaxHeap()
		list1 = [2, 9, 7, 6, 5, 8]
		test_heap.heap_sort_ascending(list1)
